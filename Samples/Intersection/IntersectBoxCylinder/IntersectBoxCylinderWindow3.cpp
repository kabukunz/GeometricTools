...
bool IntersectBoxCylinderWindow3::OnCharPress(unsigned char key, int x, int y)
{
...
void IntersectBoxCylinderWindow3::Translate(int direction, float delta)
{
...
void IntersectBoxCylinderWindow3::Rotate(int direction, float delta)
{
