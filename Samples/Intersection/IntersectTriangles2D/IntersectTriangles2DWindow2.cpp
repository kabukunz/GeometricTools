...
bool IntersectTriangles2DWindow2::OnCharPress(unsigned char key, int x, int y)
{
...
bool IntersectTriangles2DWindow2::OnMouseClick(int button, int state, int x, int y, unsigned int modifiers)
{
    return Window2::OnMouseClick(button, state, x, y, modifiers);
}

bool IntersectTriangles2DWindow2::OnMouseMotion(int button, int x, int y, unsigned int modifiers)
{
