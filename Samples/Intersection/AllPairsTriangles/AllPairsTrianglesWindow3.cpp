...
bool AllPairsTrianglesWindow3::OnCharPress(unsigned char key, int x, int y)
{
    switch (key)
    {
    case 'w':
...
bool AllPairsTrianglesWindow3::CreateCylinder(unsigned int numAxisSamples,
...
bool AllPairsTrianglesWindow3::CreateTorus(unsigned int numCircleSamples,
...
bool AllPairsTrianglesWindow3::CreateShaders()
{
    ...
    auto cshader = mInitializeColor->GetComputeShader();
    ...
    auto vshader = cylinderProgram->GetVertexShader();
