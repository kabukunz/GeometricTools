...
bool DistanceAlignedBoxOrientedBoxWindow3::OnCharPress(unsigned char key, int x, int y)
{
...
void DistanceAlignedBoxOrientedBoxWindow3::Translate(int direction, float delta)
{
...
void DistanceAlignedBoxOrientedBoxWindow3::Rotate(int direction, float delta)
{
