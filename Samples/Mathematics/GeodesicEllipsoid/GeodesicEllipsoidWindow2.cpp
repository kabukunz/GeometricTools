...
bool GeodesicEllipsoidWindow2::OnCharPress(unsigned char key, int x, int y)
{
    switch (key)
    {
    case '0':
...
void GeodesicEllipsoidWindow2::ParamToXY(GVector<float> const& param, int& x, int& y)
{
...
void GeodesicEllipsoidWindow2::XYToParam(int x, int y, GVector<float>& param)
{
